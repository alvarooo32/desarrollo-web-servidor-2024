    ...
    <div class="container">
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if($tmp_usuario == '') {
                ...
                $patron = "/^[a-zA-Z0-9_]{4,12}$/"; //de 4 a 12 caracteres
            ...
            if($tmp_nombre == '') {
                $err_nombre = "El usuario es obligatorio";
            }else{
                if(strlen($temp_nombre) < 2 || strlen($tmp_nombre) > 40){
                    $err_nombre = "El nombre debe tener entre 2 y 40 caracteres";
                }else{
                    //letras, espacios en blanco y tildes
                    $patron = "/^[a-zA-Z áéíóúÁÉÍÓÚñÑüÜ]+$/";//+ para q sepa que es mas de un caracter, coge palabra x palabra completa
